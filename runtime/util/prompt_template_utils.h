...
#ifndef THIRD_PARTY_ODML_LITERT_LM_RUNTIME_UTIL_PROMPT_TEMPLATE_UTILS_H_
#define THIRD_PARTY_ODML_LITERT_LM_RUNTIME_UTIL_PROMPT_TEMPLATE_UTILS_H_
...
#endif  // THIRD_PARTY_ODML_LITERT_LM_RUNTIME_UTIL_PROMPT_TEMPLATE_UTILS_H_
